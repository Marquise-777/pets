                ...
                <div class="signup-form">
                    <form method="POST" class="register-form" id="register-form">
                        <div class="form-row">
                            <div class="form-group">
                                <div class="form-input">
                                    <label for="first_name" class="required">Pet name</label>
                                    <input value="<?php echo $first_name ?>" name="first_name" type="text" id="text" placeholder="First name">
                                    <!-- <input type="text" name="first_name" id="first_name" /> -->
                                </div>
                                <div class="form-input">
                                    <label for="last_name" class="required">Owner name</label>
                                ...
                                <div class="form-select">
                                    <div class="label-flex">
                                        <label for="gender_preferences">Gender</label>
                                        <a href="#" class="form-link">Select Gender</a>
                                    </div>
                                    <div class="select-list">
                                        <select name="gender" id="gender_preferences">
                            ...
                            <div class="form-group">
                                <!-- <div class="form-select">
                                 ...
                                 <div class="form-input">
                                    <label for="company" class="required">Owner Address</label>
                                    <input type="text" name="company" id="company" />
                                </div>
                                <div class="form-input">
                                    <label for="company" class="required">Pet Breed</label>
                                    <input type="text" name="company" id="company" />
                                </div>
                                <div class="form-input">
                                    <label for="company" class="required">Pet DOB</label>
                                    <input type="text" name="company" id="company" />
                                </div>
                                <div class="form-radio">
                                    <div class="label-flex">
                                        <label for="payment">Vaccine</label>
                                        <a href="#" class="form-link">Vaccine Detail</a>
                                    </div>
                                    <div class="form-radio-group">            
                                        <div class="form-radio-item">
                                            <input type="radio" name="payment" id="cash" checked>
                                            <label for="cash">Not Yet</label>
                                            <span class="check"></span>
                                        </div>
                                        <div class="form-radio-item">
                                            <input type="radio" name="payment" id="cheque">
                                            <label for="cheque">Regular</label>
                                            <span class="check"></span>
                                        </div>
                                        <div class="form-radio-item">
                                            <input type="radio" name="payment" id="demand">
                                            <label for="demand">Frequently</label>
                                            <span class="check"></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-input">
                                    <label for="blank_name">Pet Blood Line</label>
                        ...
                        <div class="form-submit">
                            <input type="submit" value="Submit" class="submit" id="button" name="submit" />
